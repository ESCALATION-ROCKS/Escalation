...
/mob/living/carbon/human/FireBurn(var/firelevel, var/last_temperature, var/pressure)
	...
	apply_damage(5*mx*head_exposure,  BURN, BP_HEAD,  0, 0, "Fire")
	apply_damage(5*mx*chest_exposure, BURN, BP_CHEST, 0, 0, "Fire")
	apply_damage(4.0*mx*groin_exposure, BURN, BP_GROIN, 0, 0, "Fire")
	apply_damage(1.2*mx*legs_exposure,  BURN, BP_L_LEG, 0, 0, "Fire")
	apply_damage(1.2*mx*legs_exposure,  BURN, BP_R_LEG, 0, 0, "Fire")
	apply_damage(0.8*mx*arms_exposure,  BURN, BP_L_ARM, 0, 0, "Fire")
	apply_damage(0.8*mx*arms_exposure,  BURN, BP_R_ARM, 0, 0, "Fire")
