...
/obj/machinery/light_construct/floor/update_icon()
	switch(stage)
...
/obj/machinery/light_construct/floor/update_icon()
	switch(stage)
		if(1) icon_state = "floortube-construct-stage1"
		if(2) icon_state = "floor-construct-stage2"
		if(3) icon_state = "floortube-empty"
...
/obj/machinery/light
	...
	var/current_light = /obj/item/weapon/light/tube		// the type of light item
...
/obj/machinery/light/small
	...
	current_light = /obj/item/weapon/light/bulb

/obj/machinery/light/small/emergency
	current_light = /obj/item/weapon/light/bulb/red
...
/obj/machinery/light/spot
	...
	current_light = /obj/item/weapon/light/tube/large
...
/obj/machinery/light/New(atom/newloc, obj/machinery/light_construct/construct = null)
	...
	if(construct)
		...
		lightbulb = new current_light(src)
...
/obj/machinery/light/update_icon(var/trigger = 1)
	...
	icon_state = base_state //Weird mapping stuff causes this to be an issue.
	var/_state
...
/obj/item/weapon/light/bulb
	...
	brightness_color = "#fcfcc7"
	lighting_modes = list(
		LIGHTMODE_EMERGENCY = list(brightness_range = 3, l_max_bright = 1, l_color = "#da0205"),
		)

/obj/item/weapon/light/bulb/warmtint
	brightness_color = "#F0DC82"
...
/obj/item/weapon/light/bulb/red/readylight
	lighting_modes = list(
		LIGHTMODE_READY = list(brightness_range = 5, l_max_bright = 1, l_color = "#00ff00"),
		)
