...
/datum/grab/proc/handle_resist(var/obj/item/grab/G)
	...
	if(prob(break_chance * 2) && affecting.statscheck(affecting.skill_melee, affecting.str, 8, 0, src) && !assailant.statscheck(assailant.skill_melee, assailant.dex, 6, 0, src))
