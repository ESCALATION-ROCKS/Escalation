...
mob/proc/yank_out_object()
	...
	if(self)
		...
		playsound(src, "serinjury", rand(30,70), 1, 1)
	else
	...
	if(ishuman(src))
		...
		if(prob(selection.w_class * 10) && affected.sever_artery()) //I'M SO ANEMIC I COULD JUST -DIE-.
...
/mob/proc/set_face_dir(var/newdir, var/facingdirnull)
