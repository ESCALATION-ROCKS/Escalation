...
/datum/species
	...
	var/thirst_factor = DEFAULT_HUNGER_FACTOR // Multiplier for hunger.
	...
	var/swap_flags = null	// What can we swap place with?
...
*/
	...
	H.visible_message("<span class='notice'>[H] shakes [target].</span>", \
					"<span class='notice'>You shake [target].</span>")
