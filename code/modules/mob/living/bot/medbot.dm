/mob/living/bot/medbot
	...
	var/treatment_brute = /datum/reagent/morphine
	var/treatment_oxy = /datum/reagent/morphine
	var/treatment_fire = /datum/reagent/morphine
	var/treatment_tox = /datum/reagent/morphine
	var/treatment_virus = /datum/reagent/morphine
	var/treatment_emag = /datum/reagent/morphine
	...
	for(var/mob/living/carbon/human/H in view(7, src)) // Time to find a patient!
		if(confirmTarget(H))
			...
			if(last_newpatient_speak + 300 < world.time)
				playsound(src, 'sound/vo/hyubo/hyubofollow.wav', 70, 0, 2)
...
/mob/living/bot/medbot/UnarmedAttack(var/mob/living/carbon/human/H, var/proximity)
	...
	if(H.stat == DEAD)
		playsound(src, 'sound/vo/hyubo/hyubocurses.wav', 50, 1)
		target = null
		return

	var/t = confirmTarget(H)
	if(!t)
		var/huybook = "sound/vo/hyubo/hyubo[rand(1,10)].wav"
		if(huybook)
			playsound(src, huybook, 80, 0, 2)
		target = null
		return
