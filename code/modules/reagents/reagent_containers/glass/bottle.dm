...
/obj/item/weapon/reagent_containers/glass/bottle
	...
	update_icon()
		...
		if (!is_open_container())
			var/image/lid = image(icon, src, "[icon_state]_lid_bottle")
			overlays += lid
...
/obj/item/weapon/reagent_containers/glass/bottle/gpowder
	name = "raw gunpowder bottle"
	desc = "A small bottle of raw gunpowder. Make more ammo!."
	icon = 'icons/obj/chemical.dmi'
	icon_state = "bottle13"

	New()
		..()
		reagents.add_reagent(/datum/reagent/gpowder)
