...
/obj/item/weapon/reagent_containers/food/snacks/attack(mob/M as mob, mob/user as mob, def_zone)
	...
	if(istype(M, /mob/living/carbon))
		...
		if(reagents)								//Handle ingestion of the reagent.
			playsound(M.loc,"eat", rand(40,50), 1)
			if(reagents.total_volume)
...
/obj/item/weapon/reagent_containers/food/snacks/monkeycube/Unwrap(var/mob/user)
	icon_state = "monkeycube"
	desc = "Just add water!"
...
/obj/item/weapon/reagent_containers/food/snacks/sliceable/cheesewedge
	name = "Cheese wedge"
	desc = "A wedge of delicious Cheddar. The cheese wheel it was cut from can't have gone far."
	icon_state = "cheesewedge"
	slice_path = /obj/item/weapon/reagent_containers/food/snacks/slice/breadsys/ontop/cheese
	slices_num = 3
...
/obj/item/weapon/reagent_containers/food/snacks/plainburger/attackby(obj/item/weapon/reagent_containers/food/snacks/sliceable/cheesewedge/W as obj, mob/user as mob)
...
/obj/item/weapon/reagent_containers/food/snacks/human/burger/attackby(obj/item/weapon/reagent_containers/food/snacks/sliceable/cheesewedge/W as obj, mob/user as mob)
	if(istype(W))
		new /obj/item/weapon/reagent_containers/food/snacks/cheeseburger(src)
		to_chat(user, "You make a cheeseburger.")
		qdel(W)
...
/obj/item/weapon/reagent_containers/food/snacks/chunkohoney
	name = "Chunko-Honey"
	desc = "Well, there's no honey, to be honest."
	icon_state = "chunkohoney"
	trash = /obj/item/trash/chunkohoney
	filling_color = "#7d5f46"
	center_of_mass = "x=15;y=15"
	nutriment_amt = 1
	nutriment_desc = list("candy" = 1)
	...
	New()
		..()
		reagents.add_reagent(/datum/reagent/sugar, 3)
		reagents.add_reagent(/datum/reagent/discount, 1)
		bitesize = 1

/obj/item/weapon/reagent_containers/food/snacks/soyfood
	name = "Soy Food"
	desc = "Nutritious! Probably."
	icon_state = "soyfood"
	trash = /obj/item/trash/soyfood
	filling_color = "#7d5f46"
	center_of_mass = "x=15;y=15"
	nutriment_amt = 15
	nutriment_desc = list("chalk" = 6)
	...
	New()
		..()
		reagents.add_reagent(/datum/reagent/iron, 3)
		reagents.add_reagent(/datum/reagent/discount, 5)
		bitesize = 2