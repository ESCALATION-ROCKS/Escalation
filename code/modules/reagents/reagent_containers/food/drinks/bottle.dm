...
/obj/item/weapon/reagent_containers/food/drinks/bottle
	...
	force = 5
	drop_sound = 'sound/items/interactions/drop_glass.ogg'
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/update_icon()
	...
	if(rag)
		...
		set_light(rag.light_power, rag.light_range, 2, rag.light_color)
	else
		set_light(0)
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/crystal
	name = "'Kristall' vodka"
	desc = "Cheap booze made in DDR. Still better than Andropovka though."
	icon_state = "ddrvodka"
	center_of_mass = "x=17;y=3"
	New()
		..()
