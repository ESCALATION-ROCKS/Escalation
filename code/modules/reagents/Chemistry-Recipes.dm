...
/datum/chemical_reaction/cheesewheel/on_reaction(var/datum/reagents/holder, var/created_volume)
	var/location = get_turf(holder.my_atom)
	for(var/i = 1, i <= created_volume, i++)
		new /obj/item/weapon/reagent_containers/food/snacks/sliceable/cheesewedge(location)
...
/datum/chemical_reaction/gpowder
	name = "Gun Powder"
	result = /datum/reagent/gpowder
	required_reagents = list("sulfur" = 1, "carbon" = 1, "sodiumchloride" = 1)
	result_amount = 3
