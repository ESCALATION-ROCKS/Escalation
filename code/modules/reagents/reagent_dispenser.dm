...
/obj/structure/reagent_dispensers/fueltank/gaspump
	name = "gas pump"
	desc = "A tank containing fuel."
	icon_state = "gasstation"
	anchored = 1
...
/obj/structure/reagent_dispensers/medical
	name = "chemical tank"
	desc = "Contains some medications."
	icon = 'icons/obj/objects.dmi'
	icon_state = "chemtank"
	anchored = 0
	density = 1
