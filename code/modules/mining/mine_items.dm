...
/obj/structure/closet/secure_closet/miner/New()
	...
	new /obj/item/device/flashlight/lamp/lantern(src)
...
/obj/item/weapon/shovel/update_icon()
	if(ground > 0)
		icon_state = "[initial(icon_state)]_ground"
	else
...
/obj/item/weapon/shovel/spadenato
...
/obj/item/weapon/shovel/spadewp
	name = "MPL-50"
	icon_state = "spade_wp"
	item_state = "armyspade"
	w_class = 2
...
/obj/item/weapon/shovel/etool/update_icon()
	if(ground > 0)
		icon_state = "[initial(icon_state)]_ground"
	if(folded)
...
/obj/item/weapon/shovel/etool/attack_self(var/mob/living/user)
	if(!folded && ground == 0 && !working)
		to_chat(user, "You quickly fold the e-tool.")
		working = 1
		folded = 1
		update_icon()
		force = 5.0
		...
		to_chat(user, "You quickly unfold the e-tool.")
		folded = 0
		working = 0
		update_icon()
		force = 15.0
