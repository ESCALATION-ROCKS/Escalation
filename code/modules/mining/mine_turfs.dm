...
/turf/unsimulated/mineral/update_icon(var/update_neighbors) /////indestructible rock walls for esca
	...
	for(var/direction in step_overlays)
		...
		if(update_neighbors && istype(turf_to_check,/turf/unsimulated/stone))
...
/turf/simulated/floor/sewerwater
	name = "murky water"
...
/turf/simulated/floor/sewerwater/attackby(var/obj/item/I, mob/user as mob)
...
/turf/simulated/floor/sewerwater/Entered(atom/movable/O)
	..()
...
/turf/simulated/floor/sewerwater/deep
	density = 1
	icon_state = "deepnew"
//	icon_spawn_state = "deepnew"

/turf/simulated/floor/sewerwater/deep/CanPass(atom/movable/mover, turf/target)
	if(istype(mover,/obj/))
		return 1
