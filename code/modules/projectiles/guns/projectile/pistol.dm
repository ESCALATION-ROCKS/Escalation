...
/obj/item/weapon/gun/projectile/pistol/deputy
	name = "9x19mm pistol"
	desc = "SET DESC HERE. Uses 9mm rounds."
	icon_state = "9mmpistol"
	caliber = "9x19"
	fire_delay = 1
	load_method = MAGAZINE
	magazine_type = /obj/item/ammo_magazine/a9mmpistol
	allowed_magazines = /obj/item/ammo_magazine/a9mmpistol
	screen_shake = 0.5
	unload_sound = 'sound/weapons/gunhandling/spistol_magout.wav'
	reload_sound = 'sound/weapons/gunhandling/spistol_magin.wav'
	cocked_sound = 'sound/weapons/gunhandling/spistol_boltback.wav'
	upg_sup = 1
	magazine_type = null

/obj/item/weapon/gun/projectile/pistol/deputy/update_icon()
	..()
	if(ammo_magazine && ammo_magazine.stored_ammo.len)
		icon_state = "9mmpistol"
	else
		icon_state = "9mmpistol-empty"


/obj/item/weapon/gun/projectile/pistol/guardian
	name = ".40 pistol"
	desc = "SET DESC HERE. Uses .40 rounds."
	icon_state = "40pistol"
	caliber = ".40"
	fire_delay = 2
	load_method = MAGAZINE
	magazine_type = null
	allowed_magazines = /obj/item/ammo_magazine/a40pistol
	screen_shake = 1.5
	unload_sound = 'sound/weapons/gunhandling/spistol_magout.wav'
	reload_sound = 'sound/weapons/gunhandling/spistol_magin.wav'
	cocked_sound = 'sound/weapons/gunhandling/spistol_boltback.wav'

/obj/item/weapon/gun/projectile/pistol/guardian/update_icon()
	..()
	if(ammo_magazine && ammo_magazine.stored_ammo.len)
		icon_state = "40pistol"
	else
		icon_state = "40pistol-empty"