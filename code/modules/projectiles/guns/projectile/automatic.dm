...
/obj/item/weapon/gun/projectile/automatic/smg/mpistol
	name = "machine pistol"
	desc = "SET DESC HERE. Uses .22 LR ammo."
	icon_state = "22lrsmg"
	item_state = "ppsh"
	w_class = ITEM_SIZE_NORMAL
	load_method = MAGAZINE
	...
	slot_flags = SLOT_BELT
	magazine_type = null
	allowed_magazines = /obj/item/ammo_magazine/a22lrsmg
	unload_sound = 'sound/weapons/gunhandling/smg_magout.wav'
	reload_sound = 'sound/weapons/gunhandling/smg_magin.wav'
	cocked_sound = 'sound/weapons/gunhandling/smg_boltback.wav'

	firemodes = list(
		list(mode_name="semiauto",       burst=1, fire_delay=0,    move_delay=null, one_hand_penalty=0, burst_accuracy=null, dispersion=null),
		list(mode_name="automatic",    burst=1, fire_delay=0.2,  move_delay=3,    one_hand_penalty=1, burst_accuracy=list(1,1,0),       dispersion=list(0.0, 0.3, 0.6), automatic = 0.4),
		)

/obj/item/weapon/gun/projectile/automatic/smg/mpistol/update_icon()
	..()
	if(ammo_magazine)
		icon_state = "22lrsmg"
	else
		icon_state = "22lrsmg-empty"

/obj/item/weapon/gun/projectile/automatic/smg/fourty
	name = "sub-machine gun"
	desc = "SET DESC HERE. Uses .40 ammo."
	icon_state = "40smg"
	item_state = "wt550"
	w_class = ITEM_SIZE_NORMAL
	load_method = MAGAZINE
	...
	slot_flags = SLOT_BELT
	magazine_type = null
	allowed_magazines = /obj/item/ammo_magazine/a40smg
	one_hand_penalty = 2
	unload_sound = 'sound/weapons/gunhandling/smg_magout.wav'
	reload_sound = 'sound/weapons/gunhandling/smg_magin.wav'
	cocked_sound = 'sound/weapons/gunhandling/smg_boltback.wav'
	...
	firemodes = list(
		list(mode_name="semiauto",       burst=1, fire_delay=0,    move_delay=null, one_hand_penalty=0, burst_accuracy=null, dispersion=null),
		list(mode_name="automatic",    burst=1, fire_delay=0.2,  move_delay=3,    one_hand_penalty=3, burst_accuracy=list(1,1,0),       dispersion=list(0.0, 0.3, 0.6), automatic = 1),
		)

/obj/item/weapon/gun/projectile/automatic/smg/fourty/update_icon()
	..()
	if(ammo_magazine)
		icon_state = "40smg"
	else
		icon_state = "40smg-empty"


/obj/item/weapon/gun/projectile/automatic/ar/redline
	name = "assault rifle"
	desc = "SET DESC HERE. Uses 5.56x45mm rounds."
	icon_state = "556arifle"
	item_state = "l6closed"
	w_class = ITEM_SIZE_HUGE
	force = 15
	caliber = "5.56x45"
	...
	load_method = MAGAZINE
	magazine_type = null
	allowed_magazines = /obj/item/ammo_magazine/a556x45rifle
	one_hand_penalty = 3
	...
	firemodes = list(
		list(mode_name="semiauto",       burst=1, fire_delay=0,    move_delay=null, one_hand_penalty=4, burst_accuracy=null, dispersion=null),
		list(mode_name="automatic",    burst=1, fire_delay=0.2,  move_delay=3,    one_hand_penalty=5, burst_accuracy=list(1,1,0),       dispersion=list(0.0, 0.3, 0.6), automatic = 0.1),
		)

/obj/item/weapon/gun/projectile/automatic/ar/redline/update_icon()
	icon_state = (ammo_magazine)? "556arifle" : "556arifle-empty"
	..()
