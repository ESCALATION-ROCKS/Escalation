...
/obj/item/organ/internal/lungs/proc/handle_breath(datum/gas_mixture/breath, var/forced)
	...
	var/inhale_pp = (inhaling/breath.total_moles)*breath_pressure * 30
	var/toxins_pp = (poison/breath.total_moles)*breath_pressure * 30
	var/exhaled_pp = (exhaling/breath.total_moles)*breath_pressure * 30
