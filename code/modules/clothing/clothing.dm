/obj/item/clothing
	name = "clothing"
	picksound = 'sound/items/interactions/clothing.wav'
	drop_sound = 'sound/items/interactions/drop_clothing.ogg'
...
/obj/item/clothing/mask/gas/needs_vision_update()
	return ..() || overlay
...
/obj/item/clothing/shoes/proc/draw_item()
	...
	set desc = "Pull out item in your boots."
	set category = "IC"
	set src in usr
	...
	if(!holding)
		verbs -= /obj/item/clothing/shoes/proc/draw_item

	update_icon()
	return

/obj/item/clothing/shoes/attack_hand(var/mob/living/M)
	if(can_hold_item && holding && src.loc == M)
		draw_item()
		return
	..()

/obj/item/clothing/shoes/attackby(var/obj/item/I, var/mob/user)
	if(can_hold_item && I.w_class <= 1)
		if(holding)
...
/obj/item/clothing/suit
	...
	picksound = 'sound/items/interactions/armor_pickup.wav'
	time_to_equip = 20
	time_to_unequip = 20
...
/obj/item/clothing/under/New(var/obj/item/clothing/accessory/insignia/R)
	..()
