...
/obj/item/clothing/head/surgery/white
	desc = "A cap surgeons wear during operations. Keeps their hair from tickling your internal organs. This one is white."
...
/obj/item/clothing/head/provgov/officer
	name = "officer cap"
	desc = "Used by Provisional Government."
	icon_state = "sofficerwheelcap"

/obj/item/clothing/head/provgov/officer/chief
	name = "senior officer cap"
	icon_state = "chiefofficerwheelcap"