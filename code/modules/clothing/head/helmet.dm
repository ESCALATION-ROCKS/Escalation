...
/obj/item/clothing/head/helmet/shockproof
	name = "shockproof helmet"
	desc = "A cheap helmet which should protect you from blunt-force impacts."
	icon_state = "shockpf_helmet"
	armor = list(melee = 55, bullet = 15, laser = 0, energy = 20, bomb = 25, bio = 2, rad = 0)
