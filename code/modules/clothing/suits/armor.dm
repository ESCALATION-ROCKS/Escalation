...
/obj/item/clothing/suit/armor
	...
	var/sounded = 1
/*
/obj/item/clothing/suit/armor/handle_movement(var/turf/walking, var/running)
	if(running)
		if(sounded >= 2)
			sounded = 0
			playsound(src, "armorstep", 50, 0) // this will get annoying very fast.
		else
			sounded++
	else
		playsound(src, "armorstep", 20, 0)
*/
...
/obj/item/clothing/suit/armor/vest/vpp
	name = "VPP light vest"
	desc = "A cheap vest with some armsteel plates."
	icon_state = "vppvest_light"
...
/obj/item/clothing/suit/storage/vest/vpp
	name = "VPP light vest"
	desc = "A cheap vest with some armsteel plates."
	icon_state = "vppvest"
...
/obj/item/clothing/suit/armor/pcarrier
	...
	item_icons = list(slot_wear_suit_str = 'icons/mob/modular_armor_new.dmi')
	icon_state = "pcarrier"
	valid_accessory_slots = list(ACCESSORY_SLOT_INSIGNIA, ACCESSORY_SLOT_ARMOR_C, ACCESSORY_SLOT_ARMOR_A, ACCESSORY_SLOT_ARMOR_L, ACCESSORY_SLOT_ARMOR_S, ACCESSORY_SLOT_ARMOR_M, ACCESSORY_SLOT_ARMOR_G, ACCESSORY_SLOT_ARMOR_N)
	restricted_accessory_slots = list(ACCESSORY_SLOT_INSIGNIA, ACCESSORY_SLOT_ARMOR_C, ACCESSORY_SLOT_ARMOR_A, ACCESSORY_SLOT_ARMOR_L, ACCESSORY_SLOT_ARMOR_S, ACCESSORY_SLOT_ARMOR_G, ACCESSORY_SLOT_ARMOR_N)
	blood_overlay_type = "armor"
...
/obj/item/clothing/suit/armor/pcarrier/police
	starting_accessories = list(/obj/item/clothing/accessory/legguards, /obj/item/clothing/accessory/armor/tag/sec, /obj/item/clothing/accessory/armorplate/combinated/classiv, /obj/item/clothing/accessory/neckguard, /obj/item/clothing/accessory/storage/pouches/medium/, /obj/item/clothing/accessory/groinplate, /obj/item/clothing/accessory/armguards)
