...
/obj/item/clothing/under/brit/tiger
	name = "'Tiger Stripe' pattern uniform"
	desc = "That's a camouflaged field uniform, commonly used by regular British Forces."
	icon_state = "tiger"
	worn_state = "tiger"
	armor = list(melee = 5, bullet = 0, laser = 0,energy = 0, bomb = 0, bio = 0, rad = 5)
	siemens_coefficient = 0.7
...
/obj/item/clothing/under/brit/tiger/olive
	name = "'Tiger Stripe' pattern uniform"
	desc = "That's a camouflaged field uniform, comes with olive pants, commonly used by regular British Officers."
	icon_state = "tigero"
	worn_state = "tigero"
	armor = list(melee = 5, bullet = 0, laser = 0,energy = 0, bomb = 0, bio = 0, rad = 5)
	siemens_coefficient = 0.7
