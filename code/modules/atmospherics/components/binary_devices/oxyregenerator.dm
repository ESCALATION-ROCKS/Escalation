...
/obj/machinery/atmospherics/binary/oxyregenerator/New(var/delay)
	...
	var/co2_intake = between(0, MOLES_CELLSTANDARD*power_setting*delay/10, air1["carbon_dioxide"])//takes as much CO2 as acessible within limit of power usage, 1 level per 0.1 mole per second
