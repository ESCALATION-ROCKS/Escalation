...
/obj/machinery/portable_atmospherics/hydroponics/mstray
	name = "makeshift hydroponical tray"
...
/obj/machinery/portable_atmospherics/hydroponics/mstray/attackby(var/obj/item/O as obj, var/mob/user as mob)
	if(istype(O,/obj/item/weapon/tank))
		return
	else
		..()

/obj/machinery/portable_atmospherics/hydroponics/mstray/New()
	..()
	verbs -= /obj/machinery/portable_atmospherics/hydroponics/verb/close_lid_verb
	verbs -= /obj/machinery/portable_atmospherics/hydroponics/verb/remove_label
	verbs -= /obj/machinery/portable_atmospherics/hydroponics/verb/setlight
