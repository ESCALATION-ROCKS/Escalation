...
/proc/spawntypes()
	if(!GLOB.spawntypes)
		...
		for(var/type in typesof(/datum/spawnpoint)-/datum/spawnpoint)
			...
			if((display_name) || initial(S.always_visible))
...
/datum/spawnpoint/tunnel
	display_name = "Tunnel"
	msg = null

/datum/spawnpoint/tunnel/New()
	..()
	turfs = GLOB.latejoin

/datum/spawnpoint/communalapartment
	display_name = "Communal Apartment"
	msg = null

/datum/spawnpoint/communalapartment/New()
	..()
	turfs = GLOB.latejoin
