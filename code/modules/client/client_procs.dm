...
/client/New(TopicData)
	...
	else src.preload_rsc = "http://download1508.mediafire.com/1aekvov46s4g/l2c9dyizm882u5s/baystation12.zip" // If config.resource_urls is not set, preload like normal.
