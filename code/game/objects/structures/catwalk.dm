...
/obj/structure/catwalk/Crossed()
	. = ..()
	if(isliving(usr))
		playsound(src, pick('sound/effects/footsteps/catwalk1.ogg', 'sound/effects/footsteps/catwalk2.ogg', 'sound/effects/footsteps/catwalk3.ogg', 'sound/effects/footsteps/catwalk4.ogg', 'sound/effects/footsteps/catwalk5.ogg'), 50, 1)
