...
/obj/item/weapon/stool/soviet
	icon_state = "stool_soviet_preview" //set for the map
	base_icon = "stool_soviet_preview"

/obj/item/weapon/stool/soviet/New(var/newloc, var/new_material)
	color = null
