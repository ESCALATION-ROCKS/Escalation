...
/obj/structure/bed/soviet/
	base_icon = "bed_wp"
	icon_state = "bed_wp"

/obj/structure/bed/soviet/New(var/newloc)
	icon_state = "bed_wp"
	..(newloc,"plastic","cotton")
...
/obj/structure/bed/nato/New(var/newloc)
	icon_state = "bed_nato"
	..(newloc,"plastic","cotton")

/obj/structure/bed/empty/
	icon_state = "bed_empty"
	base_icon = "bed_empty"

/obj/structure/bed/empty/New(var/newloc)
	icon_state = "bed_empty"
	..(newloc,"plastic","cotton")
...
/obj/item/foldbed
	name = "foldable bed"
	desc = "A foldable bed that can be carried around."
	icon = 'icons/obj/furniture.dmi'
...
/obj/structure/bed/foldbed/post_buckle_mob(mob/living/M as mob)
	if(M == buckled_mob)
		set_density(1)
	else
		set_density(0)
...
/obj/structure/bed/foldbed/attackby(obj/item/weapon/W as obj, mob/user as mob)
	if(istype(W, /obj/item/weapon/wrench) || istype(W,/obj/item/stack) || istype(W, /obj/item/weapon/wirecutters))
		return
	..()

/obj/structure/bed/foldbed/buckle_mob()
	. = ..()
	if(.)
		GLOB.moved_event.register(src, src, /obj/structure/bed/roller/proc/move_buckled)

/obj/structure/bed/foldbed/unbuckle_mob()
	GLOB.moved_event.unregister(src, src)
	return ..()
