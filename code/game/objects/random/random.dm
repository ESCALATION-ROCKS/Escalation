...
/obj/random/medical/spawn_choices()
	return list(/obj/random/medical/lite = 5,
				/obj/item/bodybag = 2,
				/obj/item/weapon/reagent_containers/glass/bottle/morphine = 5,
...
/obj/random/drinkbottle/low_chance
...
/obj/random/randomid
	name = "random id"
/obj/random/randomid/spawn_choices()
	return list(/obj/item/weapon/card/id/refugeecard,
...
/obj/random/ammo/spawn_choices()
	return list(/obj/item/ammo_magazine/a40pistol = 4,
				/obj/item/ammo_magazine/a9mmpistol = 4,
				/obj/item/ammo_magazine/box/paper/x44 = 3,
				/obj/item/ammo_magazine/c32 = 4
				)
...
/obj/random/junkalt //Broken items, or stuff that could be picked up
	name = "random junk"
	icon = 'icons/obj/trash.dmi'
	icon_state = "trashbag2"

/obj/random/junkalt/spawn_choices()
	return list(/obj/item/weapon/material/shard = 5,
				...
				/obj/item/weapon/folder = 1,
				/obj/item/weapon/folder/blue = 1,
				/obj/item/weapon/folder/red = 1,
				/obj/item/weapon/folder/yellow = 1,
				/obj/item/weapon/folder/white = 1,
...
/obj/random/advdevice/spawn_choices()
	return list(/obj/item/device/flashlight/flare,
...
/obj/random/rotfood/spawn_choices()
...
/obj/random/hat/spawn_choices()
	return list(/obj/item/clothing/head/bio_hood/general = 1,
...
/obj/random/suit/spawn_choices()
	return list(/obj/item/clothing/suit/storage/hazardvest = 4,
				...
				/obj/item/clothing/suit/storage/toggle/leather_jacket/brown = 3,
...
/obj/random/buildingstuff
	name = "Random Construction Stuff"
	desc = "Hot Stuff."
	icon = 'icons/obj/weapons.dmi'
	icon_state = "lstick"
	spawn_nothing_percentage = 50

/obj/random/buildingstuff/spawn_choices()
	return list(/obj/item/weapon/material/lstick = 4,
				/obj/item/weapon/lpipe = 3,
				/obj/item/weapon/chain = 3,
				/obj/item/weapon/metalparts = 4,
				/obj/item/weapon/stone = 5,
				/obj/item/weapon/brick = 5,
				/obj/item/metal_bar = 4,
				/obj/item/stack/rods/scrap = 5,
				/obj/item/stack/metalcoil = 3,
...
obj/random/hostilenew/spawn_choices()
	return list(/mob/living/simple_animal/hostile/posthuman/androidcarrier = 1,
...
/obj/random/treelowchance/spawn_choices()
		return list(/obj/structure/flora/tree/dead,
					...
					/obj/structure/flora/snowbushes/snowgrassd = 2,
