...
/obj/effect/effect/smoke/chem
	...
	time_to_live = 600
	pass_flags = PASSTABLE | PASSGRILLE | PASSGLASS //PASS_FLAG_GLASS is fine here, it's just so the visual effect can "flow" around glass
...
/datum/effect/effect/system/smoke_spread/chem/proc/spawnSmoke(var/turf/T, var/icon/I, var/smoke_duration, var/dist = 1, var/splash_initial=0, var/obj/effect/effect/smoke/chem/passed_smoke)
	...
	if(passed_smoke)
		...
		smoke = new /obj/effect/effect/smoke/chem(location, smoke_duration + rand(150, 300), T, I)
