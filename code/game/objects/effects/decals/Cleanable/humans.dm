...
/obj/effect/decal/cleanable/blood/gibs/Crossed(AM as mob|obj)
	..()
	if(isliving(AM))
		var/mob/M = AM
		...
		playsound(src.loc, 'sound/effects/gib_step.ogg', 50, 1) // not sure how to handle metal shards with sounds
