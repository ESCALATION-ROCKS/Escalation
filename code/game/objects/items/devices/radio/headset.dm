...
/obj/item/device/radio/headset/headset_adm
	name = "radio headset"
	desc = "A generic headset."
	icon_state = "mil_headset"
	item_state = "mil_headset"
	ks1type = /obj/item/device/encryptionkey/adm

/obj/item/device/radio/headset/headset_adm/Initialize()
	. = ..()
	set_frequency(ADM_FREQ)
...
/obj/item/device/radio/headset/headset_mil
	...
	icon_state = "mil_headset"
	item_state = "mil_headset"
	ks1type = /obj/item/device/encryptionkey/mil

/obj/item/device/radio/headset/headset_mil/Initialize()
	. = ..()
	set_frequency(MIL_FREQ)

/obj/item/device/radio/headset/headset_er
	name = "radio headset"
	desc = "A generic headset."
	icon_state = "es_headset"
	item_state = "es_headset"
	ks1type = /obj/item/device/encryptionkey/emresponce

/obj/item/device/radio/headset/headset_er/Initialize()
	. = ..()
	set_frequency(ER_FREQ)
