...
/obj/item/device/encryptionkey/emresponce
	name = "ES encryption key"
	icon_state = "mil_cypherkey"
	channels = list("Emergency Service" = 1)

/obj/item/device/encryptionkey/mil
	name = "military encryption key"
	icon_state = "er_cypherkey"
	channels = list("Military" = 1)

/obj/item/device/encryptionkey/adm
	name = "administrative encryption key"
	icon_state = "adm_cypherkey"
	channels = list("Administrative" = 1)