...
/obj/item/toy/desk/newtoncradle
	...
	desc = "A super-weapon model demonstrating that Sir Isaac Newton is the deadliest sonuvabitch in space."
	icon_state = "newtoncradle"

/obj/item/toy/desk/hawaii
	name = "\improper Hawaii dancing doll"
	desc = "You wonder what the hell it does there."
	icon_state = "hawaiidancer"
