...
/obj/item/weapon/storage/fancy/masterkey/update_icon()
	return
/*
 * Crayon Box
 */
...
/obj/item/weapon/storage/fancy/keypouch
	icon_state = "keystorage"
	name = "key pouch"
	storage_slots = 6
	max_w_class = ITEM_SIZE_SMALL
	w_class = ITEM_SIZE_SMALL

	key_type = /obj/item/weapon/key
	can_hold = list(
		/obj/item/weapon/key
		)

/obj/item/weapon/storage/fancy/keypouch/stationcommander
	startswith = list(/obj/item/weapon/key/stationchief,
	/obj/item/weapon/key/hospital,
	/obj/item/weapon/key/vppkey,
	/obj/item/weapon/key/adminquart,
	/obj/item/weapon/key/engineering)

/obj/item/weapon/storage/fancy/keypouch/techchief
	startswith = list(/obj/item/weapon/key/chieftech,
	/obj/item/weapon/key/engineering,
	/obj/item/weapon/key/techstation)

/obj/item/weapon/storage/fancy/keypouch/tech
	startswith = list(/obj/item/weapon/key/engineering,
	/obj/item/weapon/key/techstation)

/obj/item/weapon/storage/fancy/keypouch/barkeeper
	startswith = list(/obj/item/weapon/key/barkeeper,
	/obj/item/weapon/key/adminquart,
	/obj/item/weapon/key/barkeeperoffice)

/obj/item/weapon/storage/fancy/keypouch/vppsarge
	startswith = list(/obj/item/weapon/key/vppkey,
	/obj/item/weapon/key/vppkeysarge)

/obj/item/weapon/storage/fancy/keypouch/police
	startswith = list(/obj/item/weapon/key/adminquart,
	/obj/item/weapon/key/pgpolice)

/obj/item/weapon/storage/fancy/keypouch/merchant
	startswith = list(/obj/item/weapon/key/adminquart,
	/obj/item/weapon/key/merchant)


/obj/item/weapon/storage/fancy/keypouch/surgerist
	startswith = list(/obj/item/weapon/key/surgerist,
	/obj/item/weapon/key/hospital)
