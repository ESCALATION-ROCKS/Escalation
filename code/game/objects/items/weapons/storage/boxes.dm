...
/obj/item/weapon/storage/box/survival/
	icon_state = "survival"
	startswith = list(/obj/item/weapon/cell/device = 1,
...
/obj/item/weapon/storage/box/shotgunammo
	...
	desc = "It has a picture of a gun and several warning symbols on the front.<br>WARNING: Live ammunition. Misuse may result in serious injury or death."
	startswith = list(/obj/item/ammo_casing/shotgun = 15)

/obj/item/weapon/storage/box/shotgunshells
	name = "box of shotgun shells"
	desc = "It has a picture of a gun and several warning symbols on the front.<br>WARNING: Live ammunition. Misuse may result in serious injury or death."
	startswith = list(/obj/item/ammo_casing/shotgun/pellet = 15)
...
/obj/item/weapon/storage/box/powercell
	name = "box of AA power cells"
	desc = "It has a picture of an AA battery."
	startswith = list(/obj/item/weapon/cell/device = 7)
