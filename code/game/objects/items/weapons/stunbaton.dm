...
/obj/item/weapon/melee/baton/electrified_arm
	name = "electrified arm"
	icon = 'icons/obj/device.dmi'
	icon_state = "electrified_arm"

/obj/item/weapon/melee/baton/electrified_arm/update_icon()
	if(status)
		icon_state = "electrified_arm_active"
		set_light(0.4, 0.1, 1, 2, "#006aff")
	else
...
/obj/item/weapon/melee/baton/stunprod
	name = "stunprod"
	desc = "A small but useful utility used to pacify some criminal elements."
	icon_state = "stunstick"
	item_state = "stunprod"
	w_class = 2
	force = 3
	throwforce = 5
...
/obj/item/weapon/melee/baton/stunprod/loaded
	bcell = /obj/item/weapon/cell/device/high