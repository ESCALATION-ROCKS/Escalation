...
/obj/item/weapon/material/twohanded/spear/wooden
	icon_state = "hc_spear0"
	base_icon = "hc_spear"
	name = "spear"
	edge = 0
	sharp = 1
...
/obj/item/weapon/material/twohanded/spear/wooden/New()
	color = null

/obj/item/weapon/material/twohanded/spear/wooden/shatter(var/consumed)
	if(!consumed)
		new /obj/item/weapon/material/lstick(get_turf(src)) //give back the wired rod
	..()
