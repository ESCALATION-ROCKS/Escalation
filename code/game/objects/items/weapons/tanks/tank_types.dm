...
/obj/item/weapon/tank/emergency/hydrogen
	name = "hydrogen tank"
	desc = "A generic tank containing hydrogen."
	icon_state = "fuelcanister"
	gauge_icon = null

/obj/item/weapon/tank/emergency/hydrogen/New()
	..()
	src.air_contents.adjust_gas("hydrogen", (3*ONE_ATMOSPHERE)*volume/(R_IDEAL_GAS_EQUATION*T20C))
