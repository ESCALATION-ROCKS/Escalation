...
/obj/item/clothing/mask/smokable/cigarette/fourtyfive
	name = "cheap cigarette"
	brand = "\improper Super 45"
	icon_state = "cigpro"

/obj/item/clothing/mask/smokable/cigarette/fourtyfive/New()
	..()
	reagents.add_reagent(/datum/reagent/nicotine/shitty/, 2)
