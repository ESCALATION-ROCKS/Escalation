...
/obj/item/proc/mob_can_equip(M as mob, slot, disable_warning = 0)
	...
	//			return 0
//			if( !(istype(src, /obj/item/device/pda) || istype(src, /obj/item/weapon/pen) || is_type_in_list(src, H.w_uniform.allowed)) )
//				return 0
		if(slot_handcuffed)
...
/obj/item/proc/zoom(mob/user, var/tileoffset = 14,var/viewsize = 7) //tileoffset is client view offset in the direction the user is facing. viewsize is how far out this thing zooms. 7 is normal view
	if(!user.client)
		return
