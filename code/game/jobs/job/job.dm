/datum/job
	...
	var/minimum_character_str = 0
	var/minimum_character_int = 0
	var/minimum_character_dex = 0
	var/minimum_character_end = 0
	var/minimum_character_soc = 0
...
/datum/job/proc/available_to(var/mob/player)
	if(minimum_character_age && (player.client.prefs.age < minimum_character_age))
		return 0
	if(minimum_character_str && (player.client.prefs.str < minimum_character_str))
		return 0
	if(minimum_character_int && (player.client.prefs.int < minimum_character_int))
		return 0
	if(minimum_character_dex && (player.client.prefs.dex < minimum_character_dex))
		return 0
	if(minimum_character_end && (player.client.prefs.end < minimum_character_end))
		return 0
	if(minimum_character_soc && (player.client.prefs.soc < minimum_character_soc))
		return 0
	return 1
