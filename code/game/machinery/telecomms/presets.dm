...
/obj/machinery/telecomms/relay/preset/firstdeck
	id = "First Floor Relay"
	autolinkers = list("1_relay")

/obj/machinery/telecomms/relay/preset/seconddeck
	id = "Second Floor Relay"
	autolinkers = list("2_relay")

/obj/machinery/telecomms/relay/preset/thirddeck
	id = "Third Floor Relay"
	autolinkers = list("3_relay")

/obj/machinery/telecomms/relay/preset/fourthdeck
	id = "Fourth Floor Relay"
	autolinkers = list("4_relay")

/obj/machinery/telecomms/relay/preset/fifthdeck
	id = "Fifth Floor Relay"
	autolinkers = list("5_relay")

/obj/machinery/telecomms/relay/preset/sixthdeck
	id = "Sixth Floor Relay"
	autolinkers = list("6_relay")

/obj/machinery/telecomms/relay/preset/sevendeck
	id = "Seven Floor Relay"
	autolinkers = list("7_relay")

/obj/machinery/telecomms/relay/preset/eightdeck
	id = "Eight Floor Relay"
	autolinkers = list("8_relay")
...
/obj/machinery/telecomms/hub/preset
	id = "Hub"
	network = "tcommsat"
	autolinkers = list("hub", "relay", "c_relay", "s_relay", "m_relay", "r_relay", "b_relay", "1_relay", "2_relay", "3_relay", "4_relay", "5_relay","6_relay", "7_relay", "8_relay",  "s_relay", "science", "medical",
	"supply", "service", "common", "command", "engineering", "security", "unused",
	"receiverA", "broadcasterA", "mil", "adm", "es")
...
/obj/machinery/telecomms/receiver/preset_right
	...
	freq_listening = list(AI_FREQ, SCI_FREQ, MED_FREQ, SUP_FREQ, SRV_FREQ, COMM_FREQ, ENG_FREQ, SEC_FREQ, ENT_FREQ, MIL_FREQ, ADM_FREQ, ER_FREQ)
...
/obj/machinery/telecomms/bus/preset_one
	id = "Bus 1"
	network = "tcommsat"
	freq_listening = list(MIL_FREQ)
	autolinkers = list("processor1", "mil")

/obj/machinery/telecomms/bus/preset_two
	id = "Bus 2"
	network = "tcommsat"
	freq_listening = list(ER_FREQ)
	autolinkers = list("processor2", "es")
/*
...
/obj/machinery/telecomms/bus/preset_three
	id = "Bus 3"
	network = "tcommsat"
	freq_listening = list(ADM_FREQ)
	autolinkers = list("processor3", "adm")
...
/obj/machinery/telecomms/server/process()
	if(on)
		playsound(src.loc, 'sound/machines/server.ogg', 30, 0, 10)
...
/obj/machinery/telecomms/server/presets/er
	id = "E.S. Server"
	freq_listening = list(ER_FREQ)
	autolinkers = list("es")

/obj/machinery/telecomms/server/presets/mil
	id = "Military Server"
	freq_listening = list(MIL_FREQ)
	autolinkers = list("mil")

/obj/machinery/telecomms/server/presets/adm
	id = "Administrative Server"
	freq_listening = list(ADM_FREQ)
	autolinkers = list("adm")
