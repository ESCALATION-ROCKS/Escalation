...
/obj/machinery/biogenerator/interact(mob/user as mob)
	...
	if (processing)
		...
		//			dat += "Nutrient<BR>"
					...
					dat += "Leather<BR>"
					dat += "<A href='?src=\ref[src];action=create;item=biodiesel;cost=120'>Biodiesel</A> <FONT COLOR=blue>([round(120/build_eff)])</FONT> | <A href='?src=\ref[src];action=create;item=biodiesel5;cost=600'>x5</A><BR>"
...
/obj/machinery/biogenerator/proc/create_product(var/item, var/cost)
	...
	switch(item)
		...
		if("biodiesel")
			new/obj/item/stack/material/biofuel(loc)
		if("biodiesel5")
			new/obj/item/stack/material/biofuel(loc)
			new/obj/item/stack/material/biofuel(loc)
			new/obj/item/stack/material/biofuel(loc)
		...
		if("leatherjacket")
			new/obj/item/clothing/suit/storage/toggle/leather_jacket/brown(loc)
		if("bomberjacket")
