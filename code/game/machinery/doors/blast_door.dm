...
// SUBTYPE: Shutters
// Nicer looking, and also weaker, shutters. Found in kitchen and similar areas.
/obj/machinery/door/blast/bars
	icon_state_open = "bars0"
	icon_state_opening = "barsc0"
	icon_state_closed = "bars1"
	icon_state_closing = "barsc1"
	icon_state = "bars1"
	open_sound = 'sound/machines/shutters_open.ogg'
	close_sound = 'sound/machines/shutters_close.ogg'
	maxhealth = 500
	...
	glass = 1
	dense = 0
	icon = 'icons/obj/doors/shutter_bars.dmi'

/obj/machinery/door/blast/bars/open
	begins_closed = FALSE
	icon_state = "bars0"

/obj/machinery/door/blast/bars/open/process
	opacity = 0

/obj/machinery/door/blast/bars/set_broken()
	..()
	deconstruct(null)

/obj/machinery/door/blast/bars/deconstruct(mob/user, moved = FALSE)
...
/obj/machinery/door/blast/bars/attackby(obj/item/I as obj, mob/user as mob)
...
/obj/machinery/door/blast/bars/shutter2
...
/obj/machinery/door/blast/bars/shutter
	icon_state_open = "shutter0"
	icon_state_opening = "shutterc0"
	icon_state_closed = "shutter1"
	icon_state_closing = "shutterc1"
